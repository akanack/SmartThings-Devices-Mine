 ...
 *  Updates:
 *  -------
 *  2016-09-19 : Initial commit to GitHub.
 *
 */

metadata {
	definition (name: "SmartSense Multi Sensor Doorbell", namespace: "akanack", author: "SmartThings") {
...
//				attributeState "closed", label:'${name}', icon:"st.contact.contact.closed", backgroundColor:"#79b821"
				attributeState "active", label:'${name}', icon:"st.motion.acceleration.active", backgroundColor:"#ffa81e"
				attributeState "inactive", label:'${name}', icon:"st.motion.acceleration.inactive", backgroundColor:"#79b821"
...
//		}
		standardTile("acceleration", "device.acceleration", width: 2, height: 2) {
			state("active", label:'${name}', icon:"st.motion.acceleration.active", backgroundColor:"#ffa81e")
			state("inactive", label:'${name}', icon:"st.motion.acceleration.inactive", backgroundColor:"#79b821")
		}
...
//private Map getContactResult(numvalue) {
//	log.debug "Acceleration"
//	def linkText = getLinkText(device)
//	def descriptionText = "${linkText} was ${value == 'active' ? 'actived' : 'inactive'}"
//	sendEvent(name: 'acceleration', value: value, descriptionText: descriptionText, displayed:false)
//	sendEvent(name: 'status', value: value, descriptionText: descriptionText)
//}
...
//	def value = numValue.endsWith("0") ? "inactive" : "active"
	def linkText = getLinkText(device)
